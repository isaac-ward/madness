...
def test_deviation_from_other_path(p1, p2):
    ...
    deviation = path1.deviation_from_other_path(path2, verbose=False)
...
if __name__ == "__main__":
    ...
    path2 = [(0, 0), (1, 1), (2, 2)]
    # Paths with perfect alignment but different lengths
    test_deviation_from_other_path(path1, path2)
    
    path1 = [(0, 0), (1, 1), (2, 2)]
    path2 = [(0, 0), (-1, -1), (-2, -2)]
    # Paths going in completely opposite directions
    test_deviation_from_other_path(path1, path2)
