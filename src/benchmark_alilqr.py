...
if __name__ == "__main__":
    # User inputs:
    min_pt_dist = 20 # Minimum distance (m) between start and goal points
    last_entry_duplicate = 200 # Number of times to duplicate last state in path
    ...
    path_xyz = map_.plan_path(xyz_initial, xyz_goal, dyn.diameter*safety_factor) # Ultra safe
    try:
